...
import { FaArrowCircleLeft, FaArrowAltCircleRight, FaHeart, FaCamera } from "react-icons/fa";
...
function LinkComponent({ destiny, text, icon: Icon, isTriggered }: LinkComponentProps) {
    return (
        <Link to={destiny} className='mb-2 px-2 block text-lg font-bold'>
...
export default function Navbar() {
    ...
    return (
        <div>
            ...
            <div className={`bg-gray-700 h-full text-white  ${isOpen ? 'w-64' : 'hidden'} md:block `}>
                <div className="">
                    <h3 className="mb-5 flex justify-center w-full pt-4 pb-5 border-b-4 ">{isOpen ? (<img src="/src/assets/Ao.png" alt="Logo" />):(<FaHeart />)}</h3>
